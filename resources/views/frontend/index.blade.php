...
@section('main-content')
    ...
    <section id="category-list">
        <div class="container-fluid" style="padding: 0">
            <div class="row">
                <div class="col-md-4" style="padding: 0; background: #F6F7FB;">
                    <!-- End Breadcrumbs -->
                    <form action="{{ route('shop.filter') }}" method="POST">
                        @csrf
                        <div class="shop-sidebar first-page">
                            <!-- Single Widget -->
                                    ...
                                    @if ($menu)
                                        @foreach ($menu as $cat_info)
                                            @if ($cat_info->child_cat->count() > 0)
                                                <li class="dropdown">
                                                    <a href="{{ route('product-cat', $cat_info->slug) }}" class="dropdown-toggle" data-toggle="dropdown">{{ $cat_info->title }}</a>
                                    ...
                                    <div class="carousel-item {{ $key == 0 ? 'active' : '' }}">
                                        ...
                                        <div class="carousel-caption d-none d-md-block text-left">
                                            ...
                                            <a class="btn btn-lg ws-btn wow fadeInUpBig"
                                                href="{{ route('product-grids') }}" role="button">Shop Now<i
